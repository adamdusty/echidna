...
auto render_pass_encoder::draw(std::uint32_t vertex_count,
...
auto render_pass_encoder::draw_indexed(std::uint32_t index_count,
                                       std::uint32_t instance_count,
...
auto render_pass_encoder::set_bind_group(std::uint32_t index,
...
auto render_pass_encoder::set_index_buffer(const buffer& buffer,
                                           index_format fmt,
                                           std::uint64_t offset,
...
auto render_pass_encoder::set_scissor_rect(std::uint32_t x,
                                           std::uint32_t y,
                                           std::uint32_t width,
...
auto render_pass_encoder::set_vertex_buffer(std::uint32_t slot,
                                            const buffer& buffer,
                                            std::uint64_t offset,
                                            std::uint64_t size) const -> void {
...
auto render_pass_encoder::set_viewport(
    float x, float y, float width, float height, float min_depth, float max_depth) const -> void {
